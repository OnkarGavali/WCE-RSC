  ...
  <div id="container">
    ...
    <!-- Start Page Banner -->
       <div class="page-banner" style="padding:40px 0;margin-top:13%; background: url(../images/slide-02-bg.jpg) center #f9f9f9;">
        ...
        <div class="row">
          <div class="col-md-6">
            <h2>Copyright Form for Paper</h2>
            <p>Manage Copyright Form for Paper</p>
          </div>
          <div class="col-md-6">
      ...
      <div class="container">
        <div class="row blog-page">
          ...
          <div class="col-md-9 page-content">
           ...
           <h4 class="classic-title"><span>My Registration</span></h4>
           <?php if(isset($_GET['upload']))
           {
            ...
            <div class="col-sm-12">
              <div class="alert alert-success alert-dismissible">
                ...
                <strong><h3 style="color:white"; <i class="fa fa-check"></i> Copyright Form Uploaded Successfully!</h3></strong>
              </div>
                </div>
            </div>
            <?php }
            ...
            <div class="col-sm-12">
              <div class="alert alert-danger alert-dismissible">
                <button class="close" aria-hidden="true" type="button" data-dismiss="alert">×</button>
                <strong><h2 style="color:white"; <i class="fa fa-warning"></i> Error Occured in Uploading Copyright Form! Please try again!</h2></strong>
              </div>
                </div>
            </div>   
            <?php }
             ...
             <div class="x_panel">
                  <div class="x_title">
                    <h2>Instructions for Copyright Form</h2>
            ...
            <ol>
              <li>
              1. Authors are requested to submit the duly signed copyright form for their paper.
              </li>
              <li>
              2. Please fill the form in the format given <a href="../copyright_form.pdf" target="_blank">here.</a> 
              </li>
              <li>
              3. Any one of the author should submit their copyright form from their RSC 2016 author accounts.
              </li>
              </ol>
              </div>    
                  </div>
               ...
               <div class="x_panel">
                  <div class="x_title">
                    <h2>Upload Copyright Form for Paper</h2>
                  ...
                  <div class="x_content">
                       <div class="row">
          <div class="col-lg-12">
             <form class="well" action="paperupload.html" method="post" enctype="multipart/form-data">
          <div class="form-group">
            <label for="file">Select a file to upload</label>
            <input type="file" name="file" required="required">
            <p class="help-block">Only .doc, .docx, .pdf, .rtf files are allowed to be uploaded.</p>
            <input type="text" name="file_label" required="required" placeholder="Label For Your File..." class="form-control" />           
            <p class="help-block">Please mention the label as your Paper Title_CRF</p>
            <select class="select2_single form-control" tabindex="-1" required="required" name="paper_id" placeholder="Please Select Your Paper Name">
...
<?php } }  
 ...
 <p class="help-block">Please Select Your Paper Title</p>
          ...
          <input type="submit" class="btn btn-md btn-primary" value="Upload">
                ...
                <div class="x_panel">
                  <div class="x_title">
                    <h2>My Uploads of Copyright Form for Paper</h2>
                  ...
                  <div class="x_content">
                   ...
                   <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                       <?php
                         $count = 1;
                         $sql = "select c.file_label,c.file_link,c.upload_time,p.paper_id,p.paper_name from paper p inner join crf_paper c inner join team t inner join users u on p.paper_id = c.paper_id AND p.paper_id = t.paper_id AND t.user_id = u.user_id where u.user_id = '$userid'";
                         $result = mysqli_query($conn, $sql);
                         if(mysqli_num_rows($result)>0){
                         while($row = mysqli_fetch_assoc($result))
                          {
                        ...
                        <tr>
                          ...
                          <td>  $row['file_label'];  </td>
                          <td>  date('d-M-Y', strtotime($row['upload_time']))  </td>
                         <td><a class="btn btn-success" href="  $row['file_link'];  "><i class="fa fa-download"></i> Download</a></td>               
                        </tr>
                      <?php  
                      $count++;
                        }
