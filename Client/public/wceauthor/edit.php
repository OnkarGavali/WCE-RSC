   ...
   <div id="content">
      <div class="container">
        <div class="row blog-page">
          ...
          <div class="col-md-9 page-content">
           <h4 class="classic-title"><span>Dashboard</span></h4>
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" method="POST" action="index.html">
                    ...
                    <strong>Please fill all the mandatory fields to complete registration procedure.</strong>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="f_name" class="form-control col-md-7 col-xs-12" name="f_name" placeholder="First Name" required="required" type="text" value="  $acm->UserFirstName();  ">
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="l_name" class="form-control col-md-7 col-xs-12" name="l_name" placeholder="Last Name" required="required" type="text"  value="  $acm->UserLastName(); ">
                        </div>
                      </div>
                       <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="email" name="email" required="required" class="form-control col-md-7 col-xs-12" type="email"  value="  $acm->UserEmail(); ">
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="telephone" name="phone" required="required" data-validate-length-range="10" class="form-control col-md-7 col-xs-12" type="tel" maxlength="10"  value="  $acm->UserContact(); ">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Select Gender <span class="required">*</span></label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <select class="select2_single form-control" tabindex="-1" required="required" name="gender">
                            <option></option>
            <?php
            if($acm->UserGender() == "Male")
            {  
            ...
            if($acm->UserGender() == "Not Specified")
            {  
            <option value="Male">Male</option>
            <option value="Female">Female</option>
            ...
            <?php }
                     ...
                     <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Select Institute <span class="required">*</span></label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <select class="select2_single form-control" tabindex="-1" required="required" name="institute">
                            <option></option>
                               <?PHP
        ...
        $result = mysqli_query($conn, $sql);
           ...
           { 
            if($acm->UserInstitute() == $row['institute_name'])
            {  
            <option value="  $row['institute_id']; " selected="selected">  $row['institute_name']; </option>
         ...
         <?php } } }  
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Select Department <span class="required" placeholder="Select Department">*</span></label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
        ...
        $result = mysqli_query($conn, $sql);
              ...
              while($row = mysqli_fetch_assoc($result))
           { 
            if($acm->UserDepartment() == $row['department_name'])
            {  
            <option value="  $row['department_id']; " selected="selected">  $row['department_name']; </option>
         ...
         <?php } } }       </select>
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Select Qualification <span class="required" placeholder="Select Department">*</span></label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
        ...
        $result = mysqli_query($conn, $sql);
              ...
              while($row = mysqli_fetch_assoc($result))
           { 
            if($acm->UserCourse() == $row['course_name'])
            {  
            <option value="  $row['course_id']; " selected="selected">  $row['course_name']; </option>
         ...
         <?php } } }     
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Select City <span class="required" placeholder="Select Department">*</span></label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
        ...
        $result = mysqli_query($conn, $sql);
              ...
              while($row = mysqli_fetch_assoc($result))
           { 
            if($acm->UserCity() == $row['city_name'])
            {  
            <option value="  $row['city_id']; " selected="selected">  $row['city_name']; </option>
         ...
         <?php } } }     
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-md-offset-3">
                          ...
                          <button id="save" type="submit" class="btn btn-success"><i class="fa fa-save"></i> Save</button>
                          <a href="index.html" class="btn btn-primary"><i class="fa fa-times"></i> Cancel</a>                        
                        </div>
                      </div>
                    </form>
                  </div>
