                        ...
                        <div className="row">
                            ...
                            <div className="col-md-3 col-sm-6 col-xs-12" data-animation="fadeIn" data-animation-delay="06">
                                <div className="team-member modern">
                                    ...
                                    <div className="progress-label">Logo Design</div>
                                    <div className="progress">
                                        <div className="progress-bar progress-bar-primary" data-progress-animation="85%" data-appear-animation-delay="800">
                                    ...
                                    <div className="progress-label">Vectors Design</div>
                                    <div className="progress">
                                        <div className="progress-bar progress-bar-primary" data-progress-animation="100%" data-appear-animation-delay="1200">
