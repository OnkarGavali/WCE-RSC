    ...
    return (
        <div>
            <div className="col-md-8" >
                ...
                <p><strong>SIXTH RESEARCH SYMPOSIUM ON COMPUTING <br />National Level joint Event by WCE ACM Student Chapter and  Department of CSE and Department of IT (WCE,Sangli) and Jabalpur College of Engineering, Jabalpur <br />At Walchand College of Engineering, Sangli.</strong></p>
                <br /><br />
